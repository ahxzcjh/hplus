    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="index_v1.jsp" data-index="0">主页示例一</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v2.jsp">主页示例二</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v3.jsp">主页示例三</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v4.jsp">主页示例四</a>
                            </li>
                            <li>
                                <a href="index_v5.jsp" target="_blank">主页示例五</a>
                            </li>
                        </ul>

                    </li>
                    <li>
                        <a class="J_menuItem" href="layouts.jsp"><i class="fa fa-columns"></i> <span class="nav-label">布局</span></a>
                    </li>
                    <li>
                        <a href="#">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="graph_echarts.jsp">百度ECharts</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="graph_flot.jsp">Flot</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="graph_morris.jsp">Morris.js</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="graph_rickshaw.jsp">Rickshaw</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="graph_peity.jsp">Peity</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="graph_sparkline.jsp">Sparkline</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="graph_metrics.jsp">图表组合</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li><a class="J_menuItem" href="blog.jsp">文章列表</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li><a href="login_v2.jsp" target="_blank">登录页面v2</a>
                                    </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="index_v1.jsp?v=4.0" frameborder="0" data-id="index_v1.jsp" seamless></iframe>
            </div>
            <div class="footer">
